    ...
    return (
      <div className="fixed bottom-6 right-6 z-50 space-y-3 flex flex-col items-end">
        <a
          ...
          className="w-12 h-12 rounded-full bg-green-500 hover:bg-green-600 shadow-lg flex items-center justify-center transition-transform hover:scale-110"
        >
        ...
        <div className="relative">
          <Button
            ...
            className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-orange-500 hover:from-blue-400 hover:to-orange-400 shadow-2xl transition-all duration-300 hover:scale-110"
          >
            ...
            <div className="p-4 border-t border-white/10">
              <form onSubmit={handleSendMessage} className="flex space-x-2">
                <Input
                  ...
                  className="flex-1 bg-white/5 border-white/10 text-white placeholder:text-gray-400 focus:border-blue-400"
                />
                <Button
                  type="submit"
