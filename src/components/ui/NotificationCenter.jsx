...
const NotificationCenter = ({ userContext = 'business' }) => {
  ...
  useEffect(() => {
    const mockNotifications = userContext === 'business' ? [
      {
        id: 1,
        type: 'order',
  ...
  const handleNotificationClick = (notification) => {
    ...
    // Navigate to relevant page (in real app, use router)
    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown Panel */}
          <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-modal border border-border z-50 max-h-96 overflow-hidden">
            {/* Header */}
