...
const Settings = () => {
    ...
    const handleSettingChange = (section: SettingSectionKey, key: string, value: any) => {
        setSettings(prev => ({
            ...prev,
            [section]: {
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h4 className="text-sm font-medium text-text-primary">Auto-detect Location</h4>
                    ...
                    <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${settings.location.autoLocation ? 'bg-primary' : 'bg-border-dark'
                            }`}
                    >
                        <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ${settings.location.autoLocation ? 'translate-x-6' : 'translate-x-1'
                                }`}
                        />
                    </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h4 className="text-sm font-medium text-text-primary">Show Exact Location</h4>
                        <p className="text-xs text-text-secondary">
                    ...
                    <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${settings.location.showExactLocation ? 'bg-primary' : 'bg-border-dark'
                            }`}
                    >
                        <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ${settings.location.showExactLocation ? 'translate-x-6' : 'translate-x-1'
                                }`}
                        />
                    </button>
                </div>
                ...
                return (
                    <div key={key} className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${value ? 'bg-primary' : 'bg-border-dark'
                                }`}
                        >
                            <span
        ...
        <div className="space-y-6">
            <div>
                ...
                >
                    ...
                    <option value="buyers">Buyers Only - Only people you're selling to</option>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h4 className="text-sm font-medium text-text-primary">Show Online Status</h4>
                        <p className="text-xs text-text-secondary">
                    ...
                    <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${settings.privacy.showOnlineStatus ? 'bg-primary' : 'bg-border-dark'
                            }`}
                    >
                        <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ${settings.privacy.showOnlineStatus ? 'translate-x-6' : 'translate-x-1'
                                }`}
                        />
                    </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h4 className="text-sm font-medium text-text-primary">Allow Contact from Buyers</h4>
                        <p className="text-xs text-text-secondary">
                            Let potential buyers message you directly
                        </p>
                    </div>
                    <button
                        onClick={() => handleSettingChange('privacy', 'allowContactFromBuyers', !settings.privacy.allowContactFromBuyers)}
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${settings.privacy.allowContactFromBuyers ? 'bg-primary' : 'bg-border-dark'
                            }`}
                    >
                        <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ${settings.privacy.allowContactFromBuyers ? 'translate-x-6' : 'translate-x-1'
                                }`}
                        />
                    </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h4 className="text-sm font-medium text-text-primary">Show Ratings Publicly</h4>
                        <p className="text-xs text-text-secondary">
                            Display your seller rating on your profile
                        </p>
                    </div>
                    <button
                        onClick={() => handleSettingChange('privacy', 'showRatingsPublicly', !settings.privacy.showRatingsPublicly)}
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${settings.privacy.showRatingsPublicly ? 'bg-primary' : 'bg-border-dark'
                            }`}
                    >
                        <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ${settings.privacy.showRatingsPublicly ? 'translate-x-6' : 'translate-x-1'
                                }`}
                        />
                    </button>
                </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h4 className="text-sm font-medium text-text-primary">Email Verification</h4>
                ...
                <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h4 className="text-sm font-medium text-text-primary">Phone Verification</h4>
                ...
                <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                    ...
                    <button
                        onClick={() => handleSettingChange('account', 'twoFactorAuth', !settings.account.twoFactorAuth)}
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 ${settings.account.twoFactorAuth ? 'bg-primary' : 'bg-border-dark'
                            }`}
                    >
                        <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ${settings.account.twoFactorAuth ? 'translate-x-6' : 'translate-x-1'
                                }`}
                        />
                    </button>
                </div>
            ...
            <button className="w-full text-left p-4 border border-border rounded-lg hover:bg-surface-secondary transition-colors duration-200">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-sm font-medium text-text-primary">Contact Support</span>
                    </div>
                    <Icon name="ChevronRight" size={16} className="text-text-secondary" />
                </div>
            </button>
            ...
            <button className="w-full text-left p-4 border border-border rounded-lg hover:bg-surface-secondary transition-colors duration-200">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-sm font-medium text-text-primary">About ProductFinder</span>
                    </div>
                    <Icon name="ChevronRight" size={16} className="text-text-secondary" />
                </div>
            </button>
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="hidden md:block">
                <div className="flex items-center justify-center space-x-1 bg-surface-secondary rounded-lg p-1 mb-6">
                    {sections.map((section) => (
                        <button
                            key={section.id}
                            onClick={() => setActiveSection(section.id)}
                            className={`flex items-center space-x-2 px-8 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${activeSection === section.id
            ...
            {/* Content */}
            <div className="justify-self-center w-[100%] md:w-[65%] bg-surface rounded-lg p-6">
