...
const ReviewsSection: React.FC<ReviewsSectionProps> = ({ reviews, businessRating, onWriteReview }) => {
							...
							<div className="flex items-center space-x-1">
								{[...Array(5)].map((_, i) => (
									<Icon
										...
										size={20}
										className={`${i < Math.floor(businessRating.average)
			...
			<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
				<div className="flex items-center space-x-4">
					<div className="flex items-center space-x-2">
						<Icon name={'Filter' as LucideIconName} size={16} className="text-text-secondary" />
						<select
							value={filterRating}
							onChange={(e: ChangeEvent<HTMLSelectElement>) => setFilterRating(e.target.value as FilterRatingType)}
				...
				<div className="flex items-center space-x-2">
					<Icon name={'ArrowUpDown' as LucideIconName} size={16} className="text-text-secondary" />
					<select
						value={sortBy}
			...
			<div className="space-y-6">
				{reviews.length === 0 ? (
					<div className="text-center py-12">
						<Icon name={'MessageSquare' as LucideIconName} size={48} className="text-text-secondary mx-auto mb-4" />
						<h3 className="text-lg font-medium text-text-primary mb-2">No Reviews Yet</h3>
						<p className="text-text-secondary mb-4">Be the first to share your experience!</p>
							...
							{review.businessReply && (
								<div className="mt-4 ml-6 p-4 bg-surface rounded-lg">
									<div className="flex items-center space-x-2 mb-2">
										<Icon name={'Store' as LucideIconName} size={16} className="text-primary" />
