...
const VendorStorefront = () => {
  ...
  const [activeTab, setActiveTab] = useState('customize'); // 'customize', 'preview', 'settings', 'public'
  ...
  const handleSaveStorefront = async (updatedData) => {
    setSaving(true);
    try {
      // Simulate API call
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className={`font-medium ${
                      storefrontData.isPublished ? 'text-success-700' : 'text-warning-700'
                    }`}>
                      {storefrontData.isPublished ? 'Storefront is Live' : 'Storefront is Draft'}
                    </p>
                    <p className={`text-sm ${
                      storefrontData.isPublished ? 'text-success-600' : 'text-warning-600'
                    }`}>
                      {storefrontData.isPublished 
